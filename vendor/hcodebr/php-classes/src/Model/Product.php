...
class Product extends Model {
    ...
    public function save()
    {
        ...
        $this->setData($results[0]);//override the object values with the values from the database
    ...
    public function getCategories()
    {
        ...
        return $sql->select("SELECT * FROM tb_categories a INNER JOIN tb_productscategories b ON a.idcategory = b.idcategory AND b.idproduct = :idproduct",[
            ':idproduct'=>$this->getidproduct()
        ]);
    }

    public static function getProductsPage($page = 1, $itemsPerPage = 3)
    {
    ...
    public static function getProductsPageSearch($search, $page = 1, $itemsPerPage = 3)
    {
        $start = ($page - 1) * $itemsPerPage;
